-- Создаём колонки для Pro-настроек
...
UPDATE wintozo_users SET message_color = '#3b82f6', message_font = 'system-ui, -apple-system, sans-serif', battle_multiplier = 1.0 WHERE username = 'admin';
