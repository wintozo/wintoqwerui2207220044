...
const s = {
  ...
  sidebar: { width: '340px', borderRight: '1px solid var(--border)', display: 'flex', flexDirection: 'column', flexShrink: 0, background: 'var(--bg-secondary)' },
  sidebarHeader: { padding: '20px', borderBottom: '1px solid var(--border)', display: 'flex', alignItems: 'center', justifyContent: 'space-between' },
  logo: { fontSize: '22px', fontWeight: 800, letterSpacing: '-1px' },
  ...
  chatItem: { display: 'flex', alignItems: 'center', padding: '12px 20px', gap: '12px', cursor: 'pointer', transition: 'background var(--transition)' },
  ...
  chatHeader: { padding: '16px 24px', borderBottom: '1px solid var(--border)', display: 'flex', alignItems: 'center', gap: '14px', background: 'var(--bg-secondary)', flexShrink: 0 },
  chatTitle: { fontWeight: 700, fontSize: '16px', flex: 1 },
  chatUsername: { fontSize: '13px', color: 'var(--text-secondary)' },
  messagesContainer: { flex: 1, overflowY: 'auto', padding: '24px', display: 'flex', flexDirection: 'column', gap: '8px' },
  msgRow: { display: 'flex' },
  msgSelf: { justifyContent: 'flex-end' },
  msgOther: { justifyContent: 'flex-start' },
  msgBubble: { maxWidth: '60%', padding: '10px 16px', borderRadius: '18px', fontSize: '14px', lineHeight: 1.4, wordBreak: 'break-word', animation: 'msgIn 0.3s ease' },
  ...
  inputBar: { display: 'flex', padding: '16px 24px', borderTop: '1px solid var(--border)', background: 'var(--bg-secondary)', gap: '10px', flexShrink: 0, alignItems: 'center' },
  ...
  sendBtn: { padding: '12px 20px', borderRadius: '24px', background: 'var(--accent)', color: 'var(--accent-text)', fontWeight: 700, cursor: 'pointer', border: 'none', fontSize: '14px', display: 'flex', alignItems: 'center', gap: '6px', transition: 'transform var(--transition)', boxShadow: 'var(--shadow-accent)' },
  topBar: { padding: '8px 20px', display: 'flex', alignItems: 'center', justifyContent: 'flex-end', gap: '8px', borderBottom: '1px solid var(--border)', background: 'var(--bg-secondary)' },
  ...
  return (
    <div style={s.layout}>
      <div style={s.sidebar}>
        <div style={s.sidebarHeader}>
          ...
          <div style={s.sidebarActions}>
            <div style={s.iconBtn} onClick={() => navigate('/messenger/computer/chat/search')}><SearchIcon size={18} /></div>
            <div style={s.iconBtn} onClick={() => navigate('/messenger/computer/settings')}><SettingsIcon size={18} /></div>
      ...
      <div style={s.chatArea}>
        ...
        {!activeChat ? (
          <div style={s.noChat}>
            <div style={s.noChatTitle}>Выбери чат</div>
            <div style={s.noChatSub}>Или найди нового пользователя через поиск</div>
          </div>
        ) : (
          <>
...
return (
            ...
            <div style={s.inputBar}>
              ...
              <button style={s.sendBtn} onClick={handleSend}><SendIcon size={16} /> Отправить</button>
            </div>
          </>
        )}
      </div>
